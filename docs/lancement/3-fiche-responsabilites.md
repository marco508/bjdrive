# Fiche de responsabilités — Responsable des Opérations BjDrive Bénin

*Ton rôle en une phrase : tu es le visage et les mains de BjDrive au Bénin.*
...
- Les former (30 min chacun) : accepter une course, récupérer au magasin, code de réception, commandes en espèces, partage GPS.
- Suivre leur sérieux : notes clients, dettes d'espèces reversées sous 48 h, comportement. **Un livreur douteux est suspendu d'abord, discuté ensuite.**

### 3. Livrer toi-même (au début)
Tu es le livreur n° 1 : tu éprouves l'application en conditions réelles, tu gardes 100 % de tes frais de livraison, et tes retours améliorent le produit chaque semaine.
...
- Bouche-à-oreille organisé : famille, amis, collègues — objectif 30 premiers clients à la main.

## Ton rituel hebdomadaire (non négociable)
...
1. **Commandes livrées par semaine** (objectif : 50/semaine à la fin du mois 2)
2. **% de livraisons en moins de 45 minutes**
3. **Clients qui recommandent dans les 30 jours**
4. **Cash livreurs récupéré à 100 %, sous 48 h**
5. **Zéro versement enseigne en retard**
