...
- [ ] 30 premiers clients recrutés à la main (famille, amis, collègues) — 1re livraison offerte
- [ ] Chaque livraison réussie = photo/story WhatsApp-TikTok (avec accord)
- [ ] Rituel en place : visio dimanche + versements lundi + dépôt cash ≤ 48 h
- [ ] Suivi des 5 chiffres chaque semaine (commandes, délais, retours clients, cash récupéré, versements à l'heure)

## Bilan à 8 semaines — on décide ensemble

| Si… | Alors… |
|---|---|
| ~50 commandes/semaine, clients qui reviennent, cash à 100 % | On élargit : quartier n° 2, nouveaux livreurs, nouvelles enseignes |
| Entre les deux | On ajuste (prix ? enseignes ? communication ?) et on refait 4 semaines |
| Très en dessous malgré le travail | On analyse honnêtement et on pivote — sans se ruiner ni se fâcher |

## Les 3 règles d'or (à ne jamais casser)

1. **Tout passe par l'application** — aucune commande ni encaissement « hors app », même en famille.
2. **Les versements du lundi ne sont JAMAIS en retard** — c'est toute la crédibilité de BjDrive.
3. **Aucun passe-droit sur les vérifications** — un ami non vérifié reste non vérifié.
