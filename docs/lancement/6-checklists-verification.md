# Checklists de vérification — BjDrive

*La vérification est NOTRE produit : c'est elle qui fait la confiance des clients. Aucun passe-droit, même pour la famille.*

## A. Vérifier une ENSEIGNE (avant publication)

**Sur place (par le Responsable des Opérations) :**
- [ ] La boutique existe physiquement, à l'adresse et à la position GPS déclarées
- [ ] Le gérant présenté est bien celui qui tient la boutique (demander aux voisins au besoin)
- [ ] **CNI du gérant** : photo recto/verso (conservée dans les notes de vérification)
- [ ] Registre de commerce / IFU si disponible (photo) — sinon le noter, à régulariser
- [ ] Photos : devanture, intérieur, rayons principaux
- [ ] Les produits annoncés sont réellement en rayon, prix affichés cohérents
...
## B. Vérifier un LIVREUR (avant sa première course)

- [ ] Recommandé par quelqu'un de confiance (le connaître personnellement au lancement)
- [ ] **CNI** : photo recto/verso conservée
- [ ] Téléphone Android fonctionnel avec data + compte Mobile Money à son nom
- [ ] Moto en état, plaque relevée
